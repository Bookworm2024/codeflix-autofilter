...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7681830527:AAEHrIBD9u1CAXEIFcDvkHduJ5bxozxqJKQ") 
    ...
    START_PIC   = os.environ.get("START_PIC", "https://t.me/trinitypics/12")
    ADMIN       = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '6011680723 1779771701 5178714818').split()]
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', 'trinityXmods').split(',')
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002495227151"))
    DUMP_CHANNEL = int(os.environ.get("DUMP_CHANNEL", "-1002495227151"))
